...
@Inject
constructor() : Action<MultiSelectionAction.Params> {
    override suspend fun Params.execute(executionContext: ExecutionContext): List<String>? {
    ...
    private fun parseData(dataObject: Map<String, Any?>?, dataList: List<String>?): Map<String, String> =
        dataObject?.mapValues { it.value?.toString() ?: "" }
            ...
            ?: throw JavaScriptException("showMultiSelection function expects object or array as argument")
