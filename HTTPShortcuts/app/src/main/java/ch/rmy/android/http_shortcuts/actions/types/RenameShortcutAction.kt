...
class RenameShortcutAction(id: String, actionType: RenameShortcutActionType, data: Map<String, String>) : BaseAction(id, actionType, data) {
    ...
    override fun createEditorView(context: Context) = RenameShortcutActionEditorView(context, this)
