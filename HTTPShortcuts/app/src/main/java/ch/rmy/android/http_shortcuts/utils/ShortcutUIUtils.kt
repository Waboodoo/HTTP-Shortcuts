...
object ShortcutUIUtils {
    ...
    fun getExecutionTypeOptions(context: Context) = getOptions(context, Shortcut.EXECUTION_TYPES, EXECUTION_TYPE_RESOURCES)
    ...
    fun getRequestBodyTypeOptions(context: Context) = getOptions(context, Shortcut.REQUEST_BODY_TYPE_OPTIONS, REQUEST_BODY_RESOURCES)
