...
- The variable widget is now scrollable (Android 12+ only) and no longer has a maximum number of lines that can be displayed
...
- You can now customize the background color of the variable widget
